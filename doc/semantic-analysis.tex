...
Binding time analysis consists of determining whether variables that are used in the program were bound.
...
Typechecking a function consists of ensuring that the returned values for all possible executions of the function (assuming just that it terminates) are compatible with the type given to it.
